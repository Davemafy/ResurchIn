  ...
  return (
    <html lang="en">
      <head>
        ...
        <meta name="description" content="Inside the six-month ResurchIn research apprenticeship." />
        <title>Program dossier — ResurchIn</title>
      ...
      <body className="inner-page program-page">
        <SiteProgress />
        {children}
      </body>
    </html>
