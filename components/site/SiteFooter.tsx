  ...
  return (
    <footer className="rv-footer">
      ...
      <div className="rv-footer-main">
        <Link className="rv-brand" href="/"><span aria-hidden="true">r/</span><b>resurchIn</b></Link>
      ...
      <div className="rv-footer-base"><span>FREE / VOLUNTEER-LED / SIX MONTHS</span><span>© 2026 RESURCHIN</span><span>OPEN WORLDWIDE</span></div>
    </footer>
  );
}
